...
namespace SigGolfCandidate.Hypertree.CounterArgs
...
/-- info: 'SigGolfCandidate.Hypertree.CounterArgs.block' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms block
...
/-- info: 'SigGolfCandidate.Hypertree.CounterArgs.equiv' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms equiv
/-- info: 'SigGolfCandidate.Hypertree.CounterArgs.check_preserves' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms check_preserves
/-- info: 'SigGolfCandidate.Hypertree.CounterArgs.finish_preserves' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms finish_preserves
/-- info: 'SigGolfCandidate.Hypertree.CounterArgs.hash_preserves' depends on axioms: [propext] -/
#guard_msgs in
#print axioms hash_preserves
end SigGolfCandidate.Hypertree.CounterArgs
