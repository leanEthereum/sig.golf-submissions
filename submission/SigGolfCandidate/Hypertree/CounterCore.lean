...
def Code (image : Image) (p : Word) : Prop :=
  instructionAt image p = some (.base .ECALL) ∧ RegisterCounter.FinishCode image (p+4)
...
theorem compute (image : Image) (hash : Hash) (p : Word) (code : Code image p)
    ...
    ∃ final, Trace hash image s 5 12 1 1 final ∧ final.pc = p-108 ∧
...
/-- info: 'SigGolfCandidate.Hypertree.CounterCore.compute' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs in
#print axioms compute
end SigGolfCandidate.Hypertree.CounterCore
