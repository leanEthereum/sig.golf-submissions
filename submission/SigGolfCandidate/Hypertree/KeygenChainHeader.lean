...
namespace SigGolfCandidate.Hypertree.KeygenChainHeader
...
def Code (image : Image) (p : Word) : Prop :=
  instructionAt image (p + 0) = some (.base (.ADDI .x10 .x0 2)) ∧
  ...
  instructionAt image (p + 68) = some (.base (.ADDI .x28 .x28 1080)) ∧
  instructionAt image (p + 72) = some (.base (.LD .x11 .x28 0)) ∧
  instructionAt image (p + 76) = some (.base (.SLLI .x11 .x11 32)) ∧
  instructionAt image (p + 80) = some (.base (.ADD .x10 .x10 .x11)) ∧
  instructionAt image (p + 84) = some (.base (.LUI .x28 128)) ∧
  instructionAt image (p + 88) = some (.base (.ADDI .x28 .x28 0)) ∧
  instructionAt image (p + 92) = some (.base (.SD .x28 .x10 0)) ∧
  instructionAt image (p + 96) = some (.base (.LUI .x28 128)) ∧
  instructionAt image (p + 100) = some (.base (.ADDI .x28 .x28 1032)) ∧
  instructionAt image (p + 104) = some (.base (.LD .x11 .x28 0)) ∧
  instructionAt image (p + 108) = some (.base (.LUI .x28 128)) ∧
  instructionAt image (p + 112) = some (.base (.ADDI .x28 .x28 8)) ∧
  instructionAt image (p + 116) = some (.base (.SD .x28 .x11 0)) ∧
  instructionAt image (p + 120) = some (.base (.LUI .x28 128)) ∧
  instructionAt image (p + 124) = some (.base (.ADDI .x28 .x28 1040)) ∧
  instructionAt image (p + 128) = some (.base (.LD .x11 .x28 0)) ∧
  instructionAt image (p + 132) = some (.base (.LUI .x28 128)) ∧
  instructionAt image (p + 136) = some (.base (.ADDI .x28 .x28 16)) ∧
  instructionAt image (p + 140) = some (.base (.SD .x28 .x11 0)) ∧
  instructionAt image (p + 144) = some (.base (.LUI .x28 128)) ∧
  instructionAt image (p + 148) = some (.base (.ADDI .x28 .x28 1048)) ∧
  instructionAt image (p + 152) = some (.base (.LD .x11 .x28 0)) ∧
  instructionAt image (p + 156) = some (.base (.LUI .x28 128)) ∧
  instructionAt image (p + 160) = some (.base (.ADDI .x28 .x28 24)) ∧
...
instance (image : Image) (p : Word) : Decidable (Code image p) :=
  inferInstanceAs (Decidable (_ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _ ∧ _))
...
theorem block (image : Image) (p : Word) (code : Code image p)
    (s : MachineState) (pc : s.pc = p) : OrdinarySteps image s 48 (state s) := by
  ...
  let s18 := execInstrBr s17 (.ADDI .x28 .x28 1080)
  let s19 := execInstrBr s18 (.LD .x11 .x28 0)
  let s20 := execInstrBr s19 (.SLLI .x11 .x11 32)
  let s21 := execInstrBr s20 (.ADD .x10 .x10 .x11)
  let s22 := execInstrBr s21 (.LUI .x28 128)
  let s23 := execInstrBr s22 (.ADDI .x28 .x28 0)
  let s24 := execInstrBr s23 (.SD .x28 .x10 0)
  let s25 := execInstrBr s24 (.LUI .x28 128)
  let s26 := execInstrBr s25 (.ADDI .x28 .x28 1032)
  let s27 := execInstrBr s26 (.LD .x11 .x28 0)
  let s28 := execInstrBr s27 (.LUI .x28 128)
  let s29 := execInstrBr s28 (.ADDI .x28 .x28 8)
  let s30 := execInstrBr s29 (.SD .x28 .x11 0)
  let s31 := execInstrBr s30 (.LUI .x28 128)
  let s32 := execInstrBr s31 (.ADDI .x28 .x28 1040)
  let s33 := execInstrBr s32 (.LD .x11 .x28 0)
  let s34 := execInstrBr s33 (.LUI .x28 128)
  let s35 := execInstrBr s34 (.ADDI .x28 .x28 16)
  let s36 := execInstrBr s35 (.SD .x28 .x11 0)
  let s37 := execInstrBr s36 (.LUI .x28 128)
  let s38 := execInstrBr s37 (.ADDI .x28 .x28 1048)
  let s39 := execInstrBr s38 (.LD .x11 .x28 0)
  let s40 := execInstrBr s39 (.LUI .x28 128)
  ...
  · rfl
  apply OrdinarySteps.step s11 s12 _ (.base (.LUI .x28 128)) 36
  ...
  · rfl
  apply OrdinarySteps.step s12 s13 _ (.base (.ADDI .x28 .x28 1072)) 35
  ...
  · rfl
  apply OrdinarySteps.step s13 s14 _ (.base (.LD .x11 .x28 0)) 34
  ...
  · simp [s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, ordinaryStep, memoryArgumentsValid, execInstrBr, signExtend12,
      accessValid, rangeValid, MEMORY_BYTES, MachineState.getReg_setReg_eq, MachineState.getReg_setReg_ne]
  apply OrdinarySteps.step s14 s15 _ (.base (.SLLI .x11 .x11 24)) 33
  ...
  · rfl
  apply OrdinarySteps.step s15 s16 _ (.base (.ADD .x10 .x10 .x11)) 32
  ...
  · rfl
  apply OrdinarySteps.step s16 s17 _ (.base (.LUI .x28 128)) 31
  ...
  · rfl
  apply OrdinarySteps.step s17 s18 _ (.base (.ADDI .x28 .x28 1080)) 30
  ...
  · rfl
  apply OrdinarySteps.step s18 s19 _ (.base (.LD .x11 .x28 0)) 29
  ...
  · simp [s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16, s17, s18, s19, ordinaryStep, memoryArgumentsValid, execInstrBr, signExtend12,
      accessValid, rangeValid, MEMORY_BYTES, MachineState.getReg_setReg_eq, MachineState.getReg_setReg_ne]
  apply OrdinarySteps.step s19 s20 _ (.base (.SLLI .x11 .x11 32)) 28
  ...
  · rfl
  apply OrdinarySteps.step s20 s21 _ (.base (.ADD .x10 .x10 .x11)) 27
  ...
  · rfl
  apply OrdinarySteps.step s21 s22 _ (.base (.LUI .x28 128)) 26
  ...
  · rfl
  apply OrdinarySteps.step s22 s23 _ (.base (.ADDI .x28 .x28 0)) 25
  ...
  · rfl
  apply OrdinarySteps.step s23 s24 _ (.base (.SD .x28 .x10 0)) 24
  ...
  · simp [s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16, s17, s18, s19, s20, s21, s22, s23, s24, ordinaryStep, memoryArgumentsValid, execInstrBr, signExtend12,
      accessValid, rangeValid, MEMORY_BYTES, MachineState.getReg_setReg_eq, MachineState.getReg_setReg_ne]
  apply OrdinarySteps.step s24 s25 _ (.base (.LUI .x28 128)) 23
  ...
  · rfl
  apply OrdinarySteps.step s25 s26 _ (.base (.ADDI .x28 .x28 1032)) 22
  ...
  · rfl
  apply OrdinarySteps.step s26 s27 _ (.base (.LD .x11 .x28 0)) 21
  ...
  · simp [s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16, s17, s18, s19, s20, s21, s22, s23, s24, s25, s26, s27, ordinaryStep, memoryArgumentsValid, execInstrBr, signExtend12,
      accessValid, rangeValid, MEMORY_BYTES, MachineState.getReg_setReg_eq, MachineState.getReg_setReg_ne]
  apply OrdinarySteps.step s27 s28 _ (.base (.LUI .x28 128)) 20
  ...
  · rfl
  apply OrdinarySteps.step s29 s30 _ (.base (.SD .x28 .x11 0)) 18
  ...
  · simp [s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16, s17, s18, s19, s20, s21, s22, s23, s24, s25, s26, s27, s28, s29, s30, ordinaryStep, memoryArgumentsValid, execInstrBr, signExtend12,
      accessValid, rangeValid, MEMORY_BYTES, MachineState.getReg_setReg_eq, MachineState.getReg_setReg_ne]
  apply OrdinarySteps.step s30 s31 _ (.base (.LUI .x28 128)) 17
  ...
  · rfl
  apply OrdinarySteps.step s31 s32 _ (.base (.ADDI .x28 .x28 1040)) 16
  ...
  · rfl
  apply OrdinarySteps.step s32 s33 _ (.base (.LD .x11 .x28 0)) 15
  ...
  · simp [s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16, s17, s18, s19, s20, s21, s22, s23, s24, s25, s26, s27, s28, s29, s30, s31, s32, s33, ordinaryStep, memoryArgumentsValid, execInstrBr, signExtend12,
      accessValid, rangeValid, MEMORY_BYTES, MachineState.getReg_setReg_eq, MachineState.getReg_setReg_ne]
  apply OrdinarySteps.step s33 s34 _ (.base (.LUI .x28 128)) 14
  ...
  · rfl
  apply OrdinarySteps.step s35 s36 _ (.base (.SD .x28 .x11 0)) 12
  ...
  · simp [s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16, s17, s18, s19, s20, s21, s22, s23, s24, s25, s26, s27, s28, s29, s30, s31, s32, s33, s34, s35, s36, ordinaryStep, memoryArgumentsValid, execInstrBr, signExtend12,
      accessValid, rangeValid, MEMORY_BYTES, MachineState.getReg_setReg_eq, MachineState.getReg_setReg_ne]
  apply OrdinarySteps.step s36 s37 _ (.base (.LUI .x28 128)) 11
  ...
  · rfl
  apply OrdinarySteps.step s37 s38 _ (.base (.ADDI .x28 .x28 1048)) 10
  ...
  · rfl
  apply OrdinarySteps.step s38 s39 _ (.base (.LD .x11 .x28 0)) 9
  ...
  · simp [s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16, s17, s18, s19, s20, s21, s22, s23, s24, s25, s26, s27, s28, s29, s30, s31, s32, s33, s34, s35, s36, s37, s38, s39, ordinaryStep, memoryArgumentsValid, execInstrBr, signExtend12,
      accessValid, rangeValid, MEMORY_BYTES, MachineState.getReg_setReg_eq, MachineState.getReg_setReg_ne]
  apply OrdinarySteps.step s39 s40 _ (.base (.LUI .x28 128)) 8
  ...
  · rfl
  apply OrdinarySteps.step s41 s42 _ (.base (.SD .x28 .x11 0)) 6
  ...
  · simp [s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16, s17, s18, s19, s20, s21, s22, s23, s24, s25, s26, s27, s28, s29, s30, s31, s32, s33, s34, s35, s36, s37, s38, s39, s40, s41, s42, ordinaryStep, memoryArgumentsValid, execInstrBr, signExtend12,
      accessValid, rangeValid, MEMORY_BYTES, MachineState.getReg_setReg_eq, MachineState.getReg_setReg_ne]
  apply OrdinarySteps.step s42 s43 _ (.base (.LUI .x10 128)) 5
  ...
  · rfl
  apply OrdinarySteps.step s43 s44 _ (.base (.ADDI .x10 .x10 0)) 4
  ...
  · rfl
  apply OrdinarySteps.step s44 s45 _ (.base (.ADDI .x11 .x0 384)) 3
  ...
  · rfl
  apply OrdinarySteps.step s45 s46 _ (.base (.LUI .x12 128)) 2
  ...
  · rfl
  apply OrdinarySteps.step s46 s47 _ (.base (.ADDI .x12 .x12 768)) 1
  ...
  · rfl
  apply OrdinarySteps.step s47 s48 _ (.base (.ADDI .x5 .x0 1)) 0
  · have hp : s47.pc = p + 188 := by simp [s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16, s17, s18, s19, s20, s21, s22, s23, s24, s25, s26, s27, s28, s29, s30, s31, s32, s33, s34, s35, s36, s37, s38, s39, s40, s41, s42, s43, s44, s45, s46, s47, execInstrBr, pc, BitVec.add_assoc]
    simpa only [fetch_at, hp] using c47
  · rfl
  exact OrdinarySteps.refl _

theorem pc (s : MachineState) : (state s).pc = s.pc + 192 := by
  simp [state,execInstrBr,BitVec.add_assoc]

theorem regs (s : MachineState) :
    (state s).getReg .x5 = 1 ∧ (state s).getReg .x10 = 0x80000 ∧
    (state s).getReg .x11 = 384 ∧ (state s).getReg .x12 = 0x80300 := by
...
theorem mem (s : MachineState) (a : Word) :
    (state s).getMem a =
      ...
      if a = 0x80000 then 2 + (s.getMem 0x80400 <<< 8) + (s.getMem 0x80428 <<< 16) + (s.getMem 0x80430 <<< 24) + (s.getMem 0x80438 <<< 32) else s.getMem a := by
  simp [state,execInstrBr,signExtend12,MachineState.getReg_setReg_eq,MachineState.getReg_setReg_ne]
...
theorem keygen_code : Code keygen 0x13e4 := by decide

/-- The generated header exactly packs all domain-separation metadata. -/
theorem words (s : MachineState) (level tree leaf chain step : Nat) (value : Reference.Digest)
  ...
  · rw [mem]
    change (BitVec.ofNat 64 2) + (s.getMem 0x80400 <<< 8) + (s.getMem 0x80428 <<< 16) + (s.getMem 0x80430 <<< 24) + (s.getMem 0x80438 <<< 32) = _
    rw [hlevel,hleaf,hchain,hstep]
...
end SigGolfCandidate.Hypertree.KeygenChainHeader
