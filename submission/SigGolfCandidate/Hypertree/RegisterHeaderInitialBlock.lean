import SigGolfCandidate.Hypertree.RegisterHeaderReady
...
theorem initial_block (image : Image) (p : Word) (code : InitialCode image p)
    ...
    OrdinarySteps image s 31 (initial s) := by
  ...
  apply OrdinarySteps.step s4 s5 _ (.base (.ADDI .x14 .x0 2)) 26
  ...
  · rfl
  apply OrdinarySteps.step s7 s8 _ (.base (.ADD .x14 .x14 .x11)) 23
  ...
  · rfl
  apply OrdinarySteps.step s10 s11 _ (.base (.ADD .x14 .x14 .x11)) 20
  ...
  · rfl
  apply OrdinarySteps.step s13 s14 _ (.base (.ADD .x14 .x14 .x11)) 17
  ...
  · rfl
  apply OrdinarySteps.step s16 s17 _ (.base (.ADD .x14 .x14 .x11)) 14
  ...
  · rfl
  apply OrdinarySteps.step s17 s18 _ (.base (.SD .x28 .x14 (-1080))) 13
...
/-- info: 'SigGolfCandidate.Hypertree.RegisterHeader.initial_block' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
