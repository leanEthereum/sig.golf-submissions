...
namespace SigGolfCandidate.Hypertree.StepBaseBlocks
...
def InitialCode (image : Image) (p : Word) : Prop :=
  ...
  instructionAt image (p+96) = some (.base (.ADDI .x10 .x28 (-1080))) ∧
  instructionAt image (p+100) = some (.base (.ADDI .x11 .x0 48)) ∧
  instructionAt image (p+104) = some (.base (.ADDI .x12 .x28 (-1048))) ∧
  instructionAt image (p+108) = some (.base (.ADDI .x5 .x0 1)) ∧
  instructionAt image (p+112) = some (.base (.ADDI .x13 .x0 1)) ∧
  instructionAt image (p+116) = some (.base (.SLLI .x13 .x13 32)) ∧
  instructionAt image (p+120) = some (.base (.JAL .x0 116))

theorem initial_block (image : Image) (p : Word) (code : InitialCode image p)
    (s : MachineState) (pc : s.pc = p) (base : s.getReg .x28 = 0x80438) :
    OrdinarySteps image s 31 (PersistentStepBase.initial s) := by
  ...
  let s25 := execInstrBr s24 (.ADDI .x10 .x28 (-1080))
  let s26 := execInstrBr s25 (.ADDI .x11 .x0 48)
  let s27 := execInstrBr s26 (.ADDI .x12 .x28 (-1048))
  let s28 := execInstrBr s27 (.ADDI .x5 .x0 1)
  let s29 := execInstrBr s28 (.ADDI .x13 .x0 1)
  let s30 := execInstrBr s29 (.SLLI .x13 .x13 32)
  let s31 := execInstrBr s30 (.JAL .x0 116)
  change OrdinarySteps image s 31 s31
  apply OrdinarySteps.step s s1 _ (.base (.LD .x11 .x28 (216))) 30
  · have hp : s.pc = p+0 := by simp [execInstrBr, pc, BitVec.add_assoc]
    simpa only [fetch_at,hp] using c0
  · have hb : s.getReg .x28 = 0x80438 := by simp [execInstrBr, MachineState.getReg_setReg_ne, base]
    simp [s1,ordinaryStep,memoryArgumentsValid,hb,signExtend12,accessValid,rangeValid,MEMORY_BYTES]
  apply OrdinarySteps.step s1 s2 _ (.base (.SD .x28 .x11 (-1048))) 29
  ...
  · rfl
  apply OrdinarySteps.step s11 s12 _ (.base (.LD .x11 .x28 (-8))) 19
  ...
  · have hb : s11.getReg .x28 = 0x80438 := by simp [s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, execInstrBr, MachineState.getReg_setReg_ne, base]
    simp [s12,ordinaryStep,memoryArgumentsValid,hb,signExtend12,accessValid,rangeValid,MEMORY_BYTES]
  apply OrdinarySteps.step s12 s13 _ (.base (.SLLI .x11 .x11 24)) 18
  ...
  · rfl
  apply OrdinarySteps.step s13 s14 _ (.base (.ADD .x10 .x10 .x11)) 17
  ...
  · rfl
  apply OrdinarySteps.step s14 s15 _ (.base (.LD .x11 .x28 (0))) 16
  ...
  · have hb : s14.getReg .x28 = 0x80438 := by simp [s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, execInstrBr, MachineState.getReg_setReg_ne, base]
    simp [s15,ordinaryStep,memoryArgumentsValid,hb,signExtend12,accessValid,rangeValid,MEMORY_BYTES]
  apply OrdinarySteps.step s15 s16 _ (.base (.SLLI .x11 .x11 32)) 15
  ...
  · rfl
  apply OrdinarySteps.step s16 s17 _ (.base (.ADD .x10 .x10 .x11)) 14
  ...
  · rfl
  apply OrdinarySteps.step s17 s18 _ (.base (.SD .x28 .x10 (-1080))) 13
  ...
  · have hb : s17.getReg .x28 = 0x80438 := by simp [s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16, s17, execInstrBr, MachineState.getReg_setReg_ne, base]
    simp [s18,ordinaryStep,memoryArgumentsValid,hb,signExtend12,accessValid,rangeValid,MEMORY_BYTES]
  apply OrdinarySteps.step s18 s19 _ (.base (.LD .x11 .x28 (-48))) 12
  ...
  · have hb : s18.getReg .x28 = 0x80438 := by simp [s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16, s17, s18, execInstrBr, MachineState.getReg_setReg_ne, base]
    simp [s19,ordinaryStep,memoryArgumentsValid,hb,signExtend12,accessValid,rangeValid,MEMORY_BYTES]
  apply OrdinarySteps.step s19 s20 _ (.base (.SD .x28 .x11 (-1072))) 11
  ...
  · have hb : s19.getReg .x28 = 0x80438 := by simp [s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16, s17, s18, s19, execInstrBr, MachineState.getReg_setReg_ne, base]
    simp [s20,ordinaryStep,memoryArgumentsValid,hb,signExtend12,accessValid,rangeValid,MEMORY_BYTES]
  apply OrdinarySteps.step s20 s21 _ (.base (.LD .x11 .x28 (-40))) 10
  ...
  · have hb : s20.getReg .x28 = 0x80438 := by simp [s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16, s17, s18, s19, s20, execInstrBr, MachineState.getReg_setReg_ne, base]
    simp [s21,ordinaryStep,memoryArgumentsValid,hb,signExtend12,accessValid,rangeValid,MEMORY_BYTES]
  apply OrdinarySteps.step s21 s22 _ (.base (.SD .x28 .x11 (-1064))) 9
  ...
  · have hb : s21.getReg .x28 = 0x80438 := by simp [s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16, s17, s18, s19, s20, s21, execInstrBr, MachineState.getReg_setReg_ne, base]
    simp [s22,ordinaryStep,memoryArgumentsValid,hb,signExtend12,accessValid,rangeValid,MEMORY_BYTES]
  apply OrdinarySteps.step s22 s23 _ (.base (.LD .x11 .x28 (-32))) 8
  ...
  · have hb : s22.getReg .x28 = 0x80438 := by simp [s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16, s17, s18, s19, s20, s21, s22, execInstrBr, MachineState.getReg_setReg_ne, base]
    simp [s23,ordinaryStep,memoryArgumentsValid,hb,signExtend12,accessValid,rangeValid,MEMORY_BYTES]
  apply OrdinarySteps.step s23 s24 _ (.base (.SD .x28 .x11 (-1056))) 7
  ...
  · have hb : s23.getReg .x28 = 0x80438 := by simp [s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16, s17, s18, s19, s20, s21, s22, s23, execInstrBr, MachineState.getReg_setReg_ne, base]
    simp [s24,ordinaryStep,memoryArgumentsValid,hb,signExtend12,accessValid,rangeValid,MEMORY_BYTES]
  apply OrdinarySteps.step s24 s25 _ (.base (.ADDI .x10 .x28 (-1080))) 6
  ...
  · rfl
  apply OrdinarySteps.step s25 s26 _ (.base (.ADDI .x11 .x0 48)) 5
  ...
  · rfl
  apply OrdinarySteps.step s26 s27 _ (.base (.ADDI .x12 .x28 (-1048))) 4
  ...
  · rfl
  apply OrdinarySteps.step s27 s28 _ (.base (.ADDI .x5 .x0 1)) 3
  ...
  · rfl
  apply OrdinarySteps.step s28 s29 _ (.base (.ADDI .x13 .x0 1)) 2
  ...
  · rfl
  apply OrdinarySteps.step s29 s30 _ (.base (.SLLI .x13 .x13 32)) 1
...
/-- info: 'SigGolfCandidate.Hypertree.StepBaseBlocks.initial_block' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms initial_block
...
def PrepareCode (image : Image) (p : Word) : Prop :=
  ...
  instructionAt image (p+12) = some (.base (.ADDI .x10 .x28 (-1080))) ∧
  instructionAt image (p+16) = some (.base (.JAL .x0 88))

theorem prepare_block (image : Image) (p : Word) (code : PrepareCode image p)
    (s : MachineState) (pc : s.pc = p) (base : s.getReg .x28 = 0x80438) :
    OrdinarySteps image s 5 (PersistentStepBase.prepare s) := by
  ...
  let s4 := execInstrBr s3 (.ADDI .x10 .x28 (-1080))
  let s5 := execInstrBr s4 (.JAL .x0 88)
  change OrdinarySteps image s 5 s5
  apply OrdinarySteps.step s s1 _ (.base (.LD .x10 .x28 (-1080))) 4
  · have hp : s.pc = p+0 := by simp [execInstrBr, pc, BitVec.add_assoc]
    simpa only [fetch_at,hp] using c0
  · have hb : s.getReg .x28 = 0x80438 := by simp [execInstrBr, MachineState.getReg_setReg_ne, base]
    simp [s1,ordinaryStep,memoryArgumentsValid,hb,signExtend12,accessValid,rangeValid,MEMORY_BYTES]
  apply OrdinarySteps.step s1 s2 _ (.base (.ADD .x10 .x10 .x13)) 3
  · have hp : s1.pc = p+4 := by simp [s1, execInstrBr, pc, BitVec.add_assoc]
    simpa only [fetch_at,hp] using c1
  · rfl
  apply OrdinarySteps.step s2 s3 _ (.base (.SD .x28 .x10 (-1080))) 2
  · have hp : s2.pc = p+8 := by simp [s1, s2, execInstrBr, pc, BitVec.add_assoc]
    simpa only [fetch_at,hp] using c2
  · have hb : s2.getReg .x28 = 0x80438 := by simp [s1, s2, execInstrBr, MachineState.getReg_setReg_ne, base]
    simp [s3,ordinaryStep,memoryArgumentsValid,hb,signExtend12,accessValid,rangeValid,MEMORY_BYTES]
  apply OrdinarySteps.step s3 s4 _ (.base (.ADDI .x10 .x28 (-1080))) 1
  · have hp : s3.pc = p+12 := by simp [s1, s2, s3, execInstrBr, pc, BitVec.add_assoc]
    simpa only [fetch_at,hp] using c3
  · rfl
  apply OrdinarySteps.step s4 s5 _ (.base (.JAL .x0 88)) 0
  · have hp : s4.pc = p+16 := by simp [s1, s2, s3, s4, execInstrBr, pc, BitVec.add_assoc]
    simpa only [fetch_at,hp] using c4
  · rfl
  exact OrdinarySteps.refl _
/-- info: 'SigGolfCandidate.Hypertree.StepBaseBlocks.prepare_block' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms prepare_block

def FinishCode (image : Image) (p : Word) : Prop :=
  instructionAt image (p+0) = some (.base (.ADDI .x6 .x6 1)) ∧
  instructionAt image (p+4) = some (.base (.SD .x28 .x6 0)) ∧
  instructionAt image (p+8) = some (.base (.JAL .x0 (-120)))

theorem finish_block (image : Image) (p : Word) (code : FinishCode image p)
    (s : MachineState) (pc : s.pc = p) (base : s.getReg .x28 = 0x80438) :
    OrdinarySteps image s 3 (PersistentStepBase.finish s) := by
  obtain ⟨c0,c1,c2⟩ := code
  let s1 := execInstrBr s (.ADDI .x6 .x6 1)
  let s2 := execInstrBr s1 (.SD .x28 .x6 0)
  let s3 := execInstrBr s2 (.JAL .x0 (-120))
  change OrdinarySteps image s 3 s3
  apply OrdinarySteps.step s s1 _ (.base (.ADDI .x6 .x6 1)) 2
  · have hp : s.pc = p+0 := by simp [execInstrBr, pc, BitVec.add_assoc]
    simpa only [fetch_at,hp] using c0
  · rfl
  apply OrdinarySteps.step s1 s2 _ (.base (.SD .x28 .x6 0)) 1
  · have hp : s1.pc = p+4 := by simp [s1, execInstrBr, pc, BitVec.add_assoc]
    simpa only [fetch_at,hp] using c1
  · have hb : s1.getReg .x28 = 0x80438 := by simp [s1, execInstrBr, MachineState.getReg_setReg_ne, base]
    simp [s2,ordinaryStep,memoryArgumentsValid,hb,signExtend12,accessValid,rangeValid,MEMORY_BYTES]
  apply OrdinarySteps.step s2 s3 _ (.base (.JAL .x0 (-120))) 0
  · have hp : s2.pc = p+8 := by simp [s1, s2, execInstrBr, pc, BitVec.add_assoc]
    simpa only [fetch_at,hp] using c2
  · rfl
  exact OrdinarySteps.refl _
/-- info: 'SigGolfCandidate.Hypertree.StepBaseBlocks.finish_block' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms finish_block
end SigGolfCandidate.Hypertree.StepBaseBlocks
