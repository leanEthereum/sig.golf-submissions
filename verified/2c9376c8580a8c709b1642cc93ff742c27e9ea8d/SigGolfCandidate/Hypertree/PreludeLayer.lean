import SigGolfCandidate.Hypertree.PreludeLayerPrepare
...
theorem sign_layer (hash : Hash) (s : MachineState) (secretKey : SecretKey) (level index : Nat)
    ...
    ∃ final instructions cycles, Trace hash signPrelude s instructions cycles
  ...
  have advance := advance_block signPrelude 0x12ac sign_advance_code done atAdvance
...
/-- info: 'SigGolfCandidate.Hypertree.Signing.Prelude.sign_layer' depends on axioms: [propext, Classical.choice, Quot.sound] -/
