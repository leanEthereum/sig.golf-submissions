import SigGolfCandidate.Hypertree.PreludeBottomSibling
...
theorem sign_bottom_tree (hash : Hash) (s : MachineState) (secretKey : SecretKey) (pointer tree : Nat)
    ...
    ∃ final instructions cycles, Trace hash signPrelude s instructions cycles 5 5 final ∧
...
/-- info: 'SigGolfCandidate.Hypertree.Signing.Prelude.sign_bottom_tree' depends on axioms: [propext, Classical.choice, Quot.sound] -/
