...
import SigGolfCandidate.Hypertree.PreludeBottomTreeFinish
...
/-- info: 'SigGolfCandidate.Hypertree.Signing.Prelude.sign_tree' depends on axioms: [propext, Classical.choice, Quot.sound] -/
