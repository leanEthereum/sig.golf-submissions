import SigGolfCandidate.Hypertree.PreludeBottomLeaf
...
theorem sign_bottom_tree_leaves (hash : Hash) (s : MachineState) (secretKey : SecretKey) (pointer tree : Nat)
    ...
    ∃ final instructions cycles, Trace hash signPrelude s instructions cycles 4 4 final ∧
  ...
  have rightPre := KeygenTreeControl.block signPrelude 0x13e4 1 344 sign_tree_right_code left leftRet
