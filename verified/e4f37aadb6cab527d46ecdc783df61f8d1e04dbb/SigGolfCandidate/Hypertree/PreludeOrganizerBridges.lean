import SigGolfCandidate.Hypertree.PreludeCandidateHonest
...
/-- info: 'SigGolfCandidate.Hypertree.PreludeCandidate.complete_of_honest_success' depends on axioms: [propext,
 Classical.choice,
 Quot.sound] -/
#guard_msgs in
