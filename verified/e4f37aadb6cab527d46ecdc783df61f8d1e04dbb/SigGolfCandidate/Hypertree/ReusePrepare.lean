...
namespace SigGolfCandidate.Hypertree.ReusePrepare
...
theorem block (image : Image) (p : Word) (code : Code image p)
    ...
    OrdinarySteps image s 30 (KeygenChainHeader.state (FusedPrepare.inputState s)) := by
  ...
  apply OrdinarySteps.step s s1 _ (.base (.LD .x11 .x28 (216))) 29
  ...
  apply OrdinarySteps.step s1 s2 _ (.base (.SD .x28 .x11 (-1048))) 28
  ...
  apply OrdinarySteps.step s2 s3 _ (.base (.LD .x11 .x28 (224))) 27
  ...
  apply OrdinarySteps.step s3 s4 _ (.base (.SD .x28 .x11 (-1040))) 26
  ...
  apply OrdinarySteps.step s4 s5 _ (.base (.ADDI .x10 .x0 2)) 25
  · have hp : s4.pc = p + 16 := by simp [s1, s2, s3, s4, execInstrBr, pc, BitVec.add_assoc]
    simpa only [fetch_at, hp] using c4
  · rfl
  apply OrdinarySteps.step s5 s6 _ (.base (.LD .x11 .x28 (-56))) 24
  ...
  · rfl
  apply OrdinarySteps.step s11 s12 _ (.base (.LD .x11 .x28 (-8))) 18
  ...
  apply OrdinarySteps.step s12 s13 _ (.base (.SLLI .x11 .x11 24)) 17
  ...
  · rfl
  apply OrdinarySteps.step s13 s14 _ (.base (.ADD .x10 .x10 .x11)) 16
  ...
  · rfl
  apply OrdinarySteps.step s14 s15 _ (.base (.LD .x11 .x28 (0))) 15
  ...
  apply OrdinarySteps.step s15 s16 _ (.base (.SLLI .x11 .x11 32)) 14
  ...
  · rfl
  apply OrdinarySteps.step s16 s17 _ (.base (.ADD .x10 .x10 .x11)) 13
  ...
  · rfl
  apply OrdinarySteps.step s17 s18 _ (.base (.SD .x28 .x10 (-1080))) 12
  ...
  apply OrdinarySteps.step s18 s19 _ (.base (.LD .x11 .x28 (-48))) 11
  ...
  apply OrdinarySteps.step s19 s20 _ (.base (.SD .x28 .x11 (-1072))) 10
  ...
  apply OrdinarySteps.step s20 s21 _ (.base (.LD .x11 .x28 (-40))) 9
  ...
  apply OrdinarySteps.step s21 s22 _ (.base (.SD .x28 .x11 (-1064))) 8
  ...
  apply OrdinarySteps.step s22 s23 _ (.base (.LD .x11 .x28 (-32))) 7
  ...
  apply OrdinarySteps.step s23 s24 _ (.base (.SD .x28 .x11 (-1056))) 6
  ...
  apply OrdinarySteps.step s24 s25 _ (.base (.ADDI .x28 .x28 (-1056))) 5
  ...
  · rfl
  apply OrdinarySteps.step s25 s26 _ (.base (.ADDI .x10 .x28 (-24))) 4
  ...
  · rfl
  apply OrdinarySteps.step s27 s28 _ (.base (.ADDI .x12 .x28 744)) 2
  ...
  · rfl
  apply OrdinarySteps.step s28 s29 _ (.base (.ADDI .x5 .x0 1)) 1
  ...
  · rfl
  apply OrdinarySteps.step s29 s30 _ (.base (.JAL .x0 120)) 0
...
/-- info: 'SigGolfCandidate.Hypertree.ReusePrepare.block' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms block
theorem header_base (s : MachineState) : (KeygenChainHeader.state s).getReg .x28 = 0x80018 := by
  simp [KeygenChainHeader.state, execInstrBr, signExtend12,
    MachineState.getReg_setReg_eq, MachineState.getReg_setReg_ne]
end SigGolfCandidate.Hypertree.ReusePrepare
