...
theorem recover_chain_fragment (hash : Hash) (s : MachineState) (level tree : Nat) (side : Bool)
    ...
    ∃ final, Trace hash verify s (9*(7-digit.val)+registerHeaderOverhead (7-digit.val)+23) (16*(7-digit.val)+registerHeaderOverhead (7-digit.val)+23) (7-digit.val) (7-digit.val) final ∧
      final.pc = 0x163c ∧
